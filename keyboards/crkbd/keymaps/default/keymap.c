...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                     GUI_T(KC_LANG2), LOWER, KC_SPC,   KC_ENT, RAISE, RALT_T(KC_LANG1) \
                                      //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     LGUI(LSFT(KC_LCBR)),KC_PGDOWN,KC_PGUP,LGUI(LSFT(KC_RCBR)),XXXXXXX, KC_RSFT,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                     GUI_T(KC_LANG2), LOWER, KC_SPC,   KC_ENT, RAISE, RALT_T(KC_LANG1) \
                                      //`--------------------------'  `--------------------------'
  ),
